                  ...
                  <div class="mdl-card__supporting-text">
                     <form action="#">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                           ...
                           <label class="mdl-textfield__label" for="firstName">Branch Name</label>
                           <span class="mdl-textfield__error">Only alphabet and no spaces, please!</span>
                        </div>
						<br>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                           <input class="mdl-textfield__input" type="email"  id="Branch_Admin_Name" />
                           <label class="mdl-textfield__label" for="Branch_Admin_Name">Branch Admin Name</label>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                           <input class="mdl-textfield__input" type="text" pattern="[A-Z,a-z]*" id="firstName" />
                           <label class="mdl-textfield__label" for="firstName">Repeat Password</label>
