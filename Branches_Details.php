      ...
      <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
         ...
         <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
            ...
            <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
               ...
               <a class="mdl-navigation__link" href="Revenue_Details.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">attach_money</i>Revenue</a>
               ...
               <a class="mdl-navigation__link" href="Batches_Details.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Batches Details</a>
               ...
               <a class="mdl-navigation__link" href="Reference_Details.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Reference Details</a>
               ...
               <!-- Start  -->
				<div class="mdl-card mdl-shadow--2dp">
                  <div class="mdl-card__title">
                     <h2 class="mdl-card__title-text">Branches Details</h2>
                  </div>
                  <div class="mdl-card__supporting-text">
					<a id="save" href="addNewBranch.php" type="submit" class="mdl-js-button mdl-button--raised mdl-button--accent">New Branch</a><br><br>
